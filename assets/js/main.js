...
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {route: a, history: b, username: c, password: d};
	});
...
var _user$project$Common_View$backToHomeLink = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text(' <- Back to home screen'),
		_1: {ctor: '[]'}
	});
...
var _user$project$Index_View$indexView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Registration_View$registrationView = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('registration-form'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
